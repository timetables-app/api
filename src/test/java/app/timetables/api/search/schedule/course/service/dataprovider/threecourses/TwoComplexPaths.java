package app.timetables.api.search.schedule.course.service.dataprovider.threecourses;
...
public class TwoComplexPaths {
    ...
    private static void secondCourse(
        ...
        Mockito.when(coursePart1.getSource()).thenReturn(place3);
        Mockito.when(coursePart1.getDestination()).thenReturn(place1);
        ...
        Mockito.when(coursePart2.getSource()).thenReturn(place1);
        Mockito.when(coursePart2.getDestination()).thenReturn(place5);
    ...
    private static void thirdCourse(
        ...
        Place place5 = placeCreator.getPlace(5L);
        Place place4 = placeCreator.getPlace(4L);
        Place place7 = placeCreator.getPlace(7L);

        CoursePart coursePart1 = Mockito.mock(CoursePart.class);
        Mockito.when(coursePart1.getId()).thenReturn(5L);
        Mockito.when(coursePart1.getSource()).thenReturn(place6);
        ...
        CoursePart coursePart2 = Mockito.mock(CoursePart.class);
        Mockito.when(coursePart2.getId()).thenReturn(6L);
        Mockito.when(coursePart2.getSource()).thenReturn(place5);
        Mockito.when(coursePart2.getDestination()).thenReturn(place4);
        ...
        Mockito.when(coursePart3.getId()).thenReturn(7L);
        Mockito.when(coursePart3.getSource()).thenReturn(place4);
